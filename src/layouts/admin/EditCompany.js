...
function EditCompany(props) {
  ...
  useEffect(() => {
    axios.get(`/api/show-companies/${id}`).then((res) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(fieldErrors).length === 0) {
      ...
      axios
        .post(`/api/update-companies/${id}`, formData, {
      ...
      <div className="row">
        ...
        >
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Edit Company</h1>
          </div>
        </div>
      </div>
          ...
          <div className="card-body">
            <div className="row">
              <div className="col-12 col-lg-12">
                {/* <h5 className="text-center">Edit Company Details</h5>
                <hr /> */}
                <form
                  className="user"
                ...
                >
                  ...
                  <div className="form-group row">
                    {/* Company Name */}
                    <div className="col-4">
                      <label forhtml="industry_name">Company Name</label>
