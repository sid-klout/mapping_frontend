...
function EditState(props) {
  ...
  useEffect(() => {
    axios.get(`/api/show-states/${id}`).then((res) => {
    ...
    switch (name) {
      case "name":
        if (value === "") {
          ...
          fieldErrors[name] = "State should only contain alphabets and spaces.";
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(fieldErrors).length === 0) {
      ...
      axios
        .post(`/api/update-states/${id}`, formData, {
      ...
      <div className="row">
        ...
        >
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Edit State</h1>
          </div>
        </div>
      </div>
      ...
      <div className="row p-3">
        ...
        <div className="card shadow mb-4">
          <div className="card-header py-3">
            <h6 className="m-0 font-weight-bold text-primary">Edit State</h6>
          </div>
          <div className="card-body">
            <div className="row">
              <div className="col-12 col-lg-12">
                {/* <h5 className="text-center">Edit State Details</h5>
                <hr /> */}
                <form
                  className="user"
                ...
                >
                  ...
                  <div className="form-group row">
                    {/* Company Name */}
                    <div className="col-4">
                      <label forhtml="industry_name">State</label>
