...
function EditCountry(props) {
  ...
  useEffect(() => {
    axios.get(`/api/show-countries/${id}`).then((res) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(fieldErrors).length === 0) {
      ...
      axios
        .post(`/api/update-countries/${id}`, formData, {
        ...
        .then((res) => {
          if (res.data.status === 200) {
            ...
            history.push("/admin/all-countries");
      ...
      <div className="row">
        ...
        >
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Edit Country</h1>
          </div>
        </div>
      </div>
      ...
      <div className="row p-3">
        ...
        <div className="card shadow mb-4">
          <div className="card-header py-3">
            <h6 className="m-0 font-weight-bold text-primary">Edit Country</h6>
          </div>
          <div className="card-body">
            <div className="row">
              <div className="col-12 col-lg-12">
                {/* <h5 className="text-center">Edit Country Details</h5>
                <hr /> */}
                <form
                  className="user"
                ...
                >
                  ...
                  <div className="form-group row">
                    {/* Company Name */}
                    <div className="col-4">
                      <label forhtml="industry_name">Country</label>
