  ...
  const deleteRow = (e, id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`/api/destroy-countries/${id}`)
          .then(function (res) {
            Swal.fire({
              icon: "success",
  ...
  return (
    <>
      <div className="d-sm-flex align-items-center justify-content-between m-4">
        <h1 className="h3 mb-0 text-gray-800">All Countries</h1>
        ...
        >
          <i className="fa fa-plus fa-sm mx-1"></i> Add Country
        </Link>
      </div>
        ...
        <div className="card shadow mb-4">
          ...
          <div className="card-body">
            <div className="row pb-4">
              <div className="col-3">
                <label forHtml="Company">Country Name</label>
                <input
                  type="text"
