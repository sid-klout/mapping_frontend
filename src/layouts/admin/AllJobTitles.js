  ...
  const deleteRow = (e, id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`/api/destroy-jobtitles/${id}`)
          .then(function (res) {
            Swal.fire({
              icon: "success",
  ...
  return (
    <>
      <div className="d-sm-flex align-items-center justify-content-between m-4">
        <h1 className="h3 mb-0 text-gray-800">All Job Titles</h1>

        <Link
          to="/admin/add-job-title"
        ...
        >
          <i className="fa fa-plus fa-sm mx-1"></i> Add Job Title
        </Link>
      </div>
        ...
        <div className="card shadow mb-4">
          ...
          <div className="card-body">
            <div className="row pb-4">
              <div className="col-3">
                <label forHtml="State">Job Title</label>
                <input
                  type="text"
